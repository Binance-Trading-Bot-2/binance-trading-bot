...
### [Features](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/wiki/Features)
...
3. Open browser `http://0.0.0.0:8080` to see the frontend
   ...
   - If you have any issue with the bot, you can check the log to find out what happened with the bot. Please take a look [Troubleshooting](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/wiki/Troubleshooting)
...
Please refer
[CHANGELOG.md](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/blob/master/CHANGELOG.md)
to view the past changes.

- [ ] Develop simple setup screen for secrets
- [ ] Allow to execute stop-loss before buy action - [#299](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/299)
- [ ] Improve sell strategy with conditional stop price percentage based on the profit percentage - [#94](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/94)
- [ ] Add sudden drop buy strategy - [#67](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/67)
- [ ] Manage setting profiles (save/change/load?/export?) - [#151](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/151)
- [ ] Improve notifications by supporting Apprise - [#106](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/106)
- [ ] Support cool time after hitting the lowest price before buy - [#105](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/105)
- [ ] Reset global configuration to initial configuration - [#97](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/97)
- [ ] Support multilingual frontend - [#56](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/56)
- [ ] Non linear stop price and chase function - [#246](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/246)
- [ ] Support STOP-LOSS configuration per grid trade for selling - [#261](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/issues/261)

## Donations

If you find this project helpful, feel free to make a small
[donation](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/blob/master/DONATIONS.md)
to the developer.
...
Thanks to all contributors :heart: [Click to see our heroes](https://github.com/Binance-Trading-Bot-2/binance-trading-bot/graphs/contributors)
